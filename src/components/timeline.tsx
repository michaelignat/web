...
export const Timeline = ({ entries }: { entries: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full font-sans" ref={containerRef}>
      <div
        ref={ref}
        className="relative max-w-7xl mx-auto pb-20 backdrop-blur-[2px] rounded-lg"
      >
        {entries.map((item) => (
          <div
            key={item.title}
            className="flex justify-start pt-8 md:gap-10 md:pt-40 md:first:pt-8"
          >
            ...
            <div className="relative pl-20 pr-10 w-full">
